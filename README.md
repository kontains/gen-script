![gen-script](./docs/public/images/gen-script.png)

## gen-script

**JS tooling for file ingestion, prompt development, and structured data extraction.**

- Docs: [microsoft.github.io/genaiscript](https://microsoft.github.io/genaiscript/) 
...
The `def` function includes the content of the file, and optimizes it if necessary for the target LLM. Gen-script script also parses the LLM output
